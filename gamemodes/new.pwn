...
{
	print("\n----------------------------------");
	print(" Blank Gamemode by Davidosick and Kirilosik");
	print("----------------------------------\n");
}
...
public OnGameModeInit()
{
	...
	mysql_connect(HOST, USER, BASE, PASS);
...
cmd:help(playerid)
{ 
    ShowPlayerDialog(playerid,0,0,"Информация","{FFFFFF}Всё работает!","Понял","");
    return 1; 
}